...
class RobotVisualization:
    ...
    def _draw_robot(self, position, direction):
        """Returns a polygon representing a robot
    ...
    def update(self, room, robots):
        """Redraws the visualization with the
        specified room and robot state."""
    ...
    def done(self):
        """Indicate that the animation is done so that we allow the user
        to close the window."""
        mainloop()
